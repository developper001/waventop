...
class WavenDbTop:
  ...
  config = {
    ...
    'wavendb_uris_to_analyse': {
      ...
      'Bouvaloir Orok': f'page=1&weapon=497&version={api_version}',
      'Scalpel Apostruker': f'page=1&weapon=637&version={api_version}',
      'Aiguille Pikuxala': f'page=1&weapon=945&version={api_version}',
      'Écorcheur Shugen': f'page=1&weapon=36&version={api_version}',
      'Lame Voracius': f'page=1&weapon=202&version={api_version}',
      'Synchronisateur Tako': f'page=1&weapon=490&version={api_version}',
    },
    'public': 'public',
    'pages': 'pages',
